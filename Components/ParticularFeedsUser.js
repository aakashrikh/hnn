                ...
                <View style={{ flexDirection: "row" }}>
                  {/* logo */}
                  {
                    feeds.vendor_profile_pic == null ?
                      ...
                      :
                      <Image source={{ uri: global.image_url + feeds.user_profile_pic }}
                        style={style.profileImage} />
                  }
                  {/* name and time */}
                  <View style={{ flexDirection: "column", paddingLeft: 15 }}>
                    ...
                    <Text style={style.postTime}>
                      {moment.utc(feeds.created_at).local().startOf('seconds').fromNow()}
                    </Text>
                  </View>
                </View>
                          ...
                          <View style={style.modalView}>
                            ...
                            <TouchableOpacity
                              ...
                              <LinearGradient
                                ...
                                <Text style={[styles.textSignIn, { alignSelf: "center", color: '#fff' }]}>
                                  Submit</Text>
              ...
              <View>
                ...
                <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                  <View style={{ flexDirection: "row" }}>
                    ...
                    <Text style={{ margin: 5 }}>
                      <Icon type="ionicon" onPress={() => this.props.navigation.navigate("Comments", {
                        description: feeds.feed_description,
